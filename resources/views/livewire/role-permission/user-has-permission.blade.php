        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last mb-2 d-flex justify-content-between align-items-center">
                    <h3>{{ __('role-permission.user_has_permission.title')}}</h3>
                    <div class="d-flex">
                ...
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{ __('role-permission.user_has_permission.title')}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="card widget-todo">
                        ...
                        <div class="card-footer d-flex justify-content-center px-1 py-1">
                            <button wire:click="save" class="btn btn-primary">{{ __('role-permission.user_has_permission.button_save')}}</button>
                        </div>
                    </div>
                </div>
            </div>
