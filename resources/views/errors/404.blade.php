...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('mazer/dist/assets/css/pages/error.css') }}">
</head>
    ...
    <div id="error">
        ...
        <div class="error-page container">
            <div class="col-md-8 col-12 offset-md-2">
                <img class="img-error" src="{{ asset('mazer/dist/assets/images/samples/error-404.png') }}" alt="Not Found">
