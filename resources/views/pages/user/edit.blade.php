            ...
            <div class="card">
                <div class="card-body">
                    <x-form.index action="{{ route('user.update', $user->id )}}" method="PUT">
                        <x-form.vertical-input type="text" name="name" label="name" value="{{ $user->name }}" required="false" />
                        <x-form.vertical-input type="text" name="full_name" label="full name" value="{{ $user->full_name }}" required="false" />
                        <x-form.vertical-input type="email" name="email" label="email" value="{{ $user->email }}" readonly="true" />
                    </x-form.index>
                </div>
        </section>
    </div>
