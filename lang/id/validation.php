...
return [
    ...
    */
    ...
    | menentukan baris bahasa tertentu untuk aturan atribut yang diberikan.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Baris Bahasa Atribut Validasi Khusus
    |--------------------------------------------------------------------------
    |
    ...
    | "email". Ini benar-benar membantu kita membuat pesan sedikit lebih jelas.
    |
    */
